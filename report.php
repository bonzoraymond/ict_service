			...
			<table class="table table-hover table-bordered" id="list">
				...
				<tbody>
					...
					if($_SESSION['login_type'] == 3)
						$where .= " where t.Staff_Member_id = {$_SESSION['login_id']} ";
					$qry = $conn->query("SELECT t.*,concat(c.lastname,', ',c.firstname,' ',c.middlename) as cname FROM tickets t inner join Staff_Members c on c.id= t.Staff_Member_id $where order by unix_timestamp(t.date_created) desc");
